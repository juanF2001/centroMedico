function consultarPaciente(){
 var url = "index.php?accion=consultarPaciente=" +
...
function cargarHoras(){
     ...
     url = "index.php?accion=consultarHoras&" + queryString;
     $("#hora").load(url);
    }
}
...
function consultarCitas(){
    url = "index.php?accion=consultarCitas&consultarDocumento" +$("#consultarDocumento").val();
    $("#paciente2").val(url);
}
